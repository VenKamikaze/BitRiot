...
{
  Rocket::Core::ElementText* textNode =
		dynamic_cast<Rocket::Core::ElementText*>(element->GetFirstChild());
...
void MickRocketElementUtil::replaceEndCharInTextNode(Rocket::Core::Element* element, std::string toReplace)
{
  Rocket::Core::ElementText* textNode =
		dynamic_cast<Rocket::Core::ElementText*>(element->GetFirstChild());
  Rocket::Core::String utf8_string;
  textNode->GetText().ToUTF8(utf8_string);
  utf8_string.Resize(utf8_string.Length()-1);
